          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-3">
                {pump.name}
                <span className="w-4 h-4 rounded-full bg-[#1c8f45] inline-block"></span>
              </h1>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-white rounded-lg p-6 flex-1 flex flex-col">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="border-2 border-[#86efac] rounded-lg p-4 flex flex-col justify-between bg-[#f0fdf4]">
                  ...
                  <div className="text-2xl font-bold text-[#182363]">{pump.vibration} <span className="text-base font-bold">mm/s</span></div>
                </div>
                <div className="border-2 border-[#86efac] rounded-lg p-4 flex flex-col justify-between bg-[#f0fdf4]">
                  <div className="text-xs text-gray-500 font-semibold mb-1">Temperature</div>
                  <div className="text-2xl font-bold text-[#182363]">{pump.temperature} <span className="text-base font-bold">°F</span></div>
                </div>
                <div className="border-2 border-[#86efac] rounded-lg p-4 flex flex-col justify-between bg-[#f0fdf4]">
                  <div className="text-xs text-gray-500 font-semibold mb-1">Pressure</div>
                  <div className="text-2xl font-bold text-[#182363]">{pump.pressure} <span className="text-base font-bold">psi</span></div>
                </div>
                <div className="border-2 border-[#fde047] rounded-lg p-4 flex flex-col justify-between bg-[#fefce8]">
                  ...
                  <div className="text-2xl font-bold text-gray-900">{pump.flowRate} <span className="text-base font-bold">gpm</span></div>
                </div>
                <div className="border-2 border-[#86efac] rounded-lg p-4 flex flex-col justify-between bg-[#f0fdf4]">
                  <div className="text-xs text-gray-500 font-semibold mb-1">Power</div>
                  <div className="text-2xl font-bold text-[#182363]">{pump.power} <span className="text-base font-bold">kW</span></div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg p-6 flex flex-col gap-4 h-full">
            ...
            <div className="bg-[#f0fdf4] border border-[#86efac] rounded p-3">
              ...
              <div className="text-2xl font-bold text-gray-900 mb-1">{pump.ai.healthScore}%</div>
